...
| World Model Implicit Planning | /home/alan/hermes-projects/research-flywheel/artifacts/HWorld-Model-Implicit-Planning.md | Architecture | The World-Value-Action architecture for predictive world modeling and implicit planning. |
...
| Verified Planning Epistemic Control | /home/alan/hermes-projects/research-flywheel/artifacts/Verified-Planning-Epistemic-Control.md | Architecture | Active Epistemic Control (AEC) for verified planning by decoupling Belief and Fact stores. |
| Agentic Trust SOTA 2026 | /home/alan/hermes-projects/research-flywheel/artifacts/Agentic-Trust-SOTA-2026.md | Research | Decentralized Trust Stack ($\\text{L}_{id} \\rightarrow \\text{L}_{comp} \\rightarrow \\text{L}_{Lrep}$) for preventing Sybil attacks in agent economies. |
