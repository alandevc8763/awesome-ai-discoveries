...
| **Blue's DIL** | Knowledge Management | Blueprint for unifying diverse sources via declarative data planners. | [Link](https://arxiv.org/abs/2604.15222) |
| **IG-Search** | Search / Reasoning | Step-level information gain rewards for precise search-augmented reasoning. | [Link](https://arxiv.org/abs/2604.15148) |
| **CoopEval** | Multi-Agent | Benchmarks and mechanisms (contracts, mediation) for sustaining cooperation. | [Link](https://arxiv.org/abs/2604.15267) |
| **Gaming Verifiers** | RL / Safety | Detects reward hacking in RLVR via Isomorphic Perturbation Testing. | [Link](https://arxiv.org/abs/2604.15149) |
